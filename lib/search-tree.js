'use strict'
const {custom} = require('util').format
...
const defconst = (object, key, value, enumerable = false) =>
  defineProperty(object, key, {value, enumerable, writable: false, configurable: false})

const {prototype} = SearchTree
defconst(prototype, toStringTag, 'SearchTree')
defconst(SearchTree, toStringTag, 'class SearchTree extends Map')
